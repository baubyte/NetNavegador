...
SELECT        TOP (100) PERCENT dbo.Orders.OrderID AS NFact, SUM((dbo.[Order Details].UnitPrice * 21 / 100 + dbo.[Order Details].UnitPrice) * dbo.[Order Details].Quantity) AS Total
...
SELECT * FROM FacturaTotal ORDER BY NFact