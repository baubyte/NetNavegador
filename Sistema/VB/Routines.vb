...
Module Routines
    ...
    Function LeerConfig(ByVal archivo As String) As String
        'En le archivo hostDb.txt poner la instancia de SQL p. ej: BAUBYTE-NOTE\SQLEXPRESS14
        If File.Exists("C:\Connections\ConfigDb.txt") = True Then
    ...
    Function YaExisteSql(ByVal sql As String) As Boolean
        ...
        Dim ar As String
        Dim connection As New SqlConnection(CStr(LeerConfig(ar)))
